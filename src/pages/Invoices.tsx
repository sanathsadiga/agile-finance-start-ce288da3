...
import { FileText, Download, MoreHorizontal, Plus, Search, Mail, Settings } from "lucide-react";
...
import InvoiceTemplateManager from '@/components/invoices/InvoiceTemplateManager';
...
const Invoices = () => {
  ...
  const { invoices, addInvoice, updateInvoice, deleteInvoice, fetchInvoices } = useInvoices();
  ...
  }, [activeTab, fetchInvoices, fetchTemplates]);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          <div>
            ...
            <p className="text-gray-600">Manage your customer invoices and templates</p>
          </div>
          <div className="flex flex-wrap gap-2">
            <Button onClick={handleManageTemplates} variant="outline">
                              ...
                              onClick={() => {
                                if (invoice.status === 'unpaid') {
                                  ...
                                  toast({ 
                                    ...
                                    description: `Invoice ${invoice.invoice_number || invoice.id} has been marked as paid.` 
                                  });
                                }
                              }}
                            >
                          ...
                          <td className="py-4 px-4 text-right">
                            <div className="flex justify-end gap-1">
                              <Button 
                                variant="ghost" 
                                size="icon" 
                                onClick={() => invoice.email && handleSendEmail(invoice.invoice_number || invoice.id, invoice.email)}
                                title="Send email"
                              >
                              ...
                              <Button 
                                variant="ghost" 
                                size="icon" 
                                onClick={() => handleDownload(invoice.invoice_number || invoice.id)}
                                title="Download"
                              >
          ...
          <TabsContent value="templates">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage your custom invoice templates</CardDescription>
              </CardHeader>
              <CardContent>
                <InvoiceTemplateManager onClose={() => {}} />
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
      ...
      <Dialog open={showTemplateManager} onOpenChange={setShowTemplateManager}>
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          ...
          <InvoiceTemplateManager onClose={() => setShowTemplateManager(false)} />
        </DialogContent>
      </Dialog>
    </div>
  );
